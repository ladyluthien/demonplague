## Beastmaster
[https://a5e.tools/node/3748](https://a5e.tools/node/3748)
## Hunter
...
Cold resistance → cold immunity Fire resistance → fire immunity Poison immunity → immunity to all poisons and the poisoned condition Climbing speed → 10 ft faster climbing speed Swimming speed → 10 ft faster swimming speed
...
_Source: Secrets of the Selkie_

## Wildborn

[https://a5e.tools/node/3755](https://a5e.tools/node/3755)
